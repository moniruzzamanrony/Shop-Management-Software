   ...
   private DbConnector connector = new DbConnector();
    ...
    private void save() {
        ...
        String query = "INSERT INTO `suppliers` (`id`, `name`, `phone_no`, `email`, `company_name`, `bank_name`, `bank__ac_no`, `address`, `is_active`) "
                + "VALUES ('"+ApplicationUtils.getRandomInt()+"', '"+name.getText().toString()+"', '"+mobileName.getText().toString()+"', '"+mobileName.getText().toString()+"', '"+companyName.getText().toString()+"', '"+bankName.getText().toString()+"', '"+bankAcName.getText().toString()+"', '"+address.getText().toString()+"', b'1');";
